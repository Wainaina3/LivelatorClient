 ...
 * {@link Translate_Text.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Translate_Text#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Translate_Text extends Fragment {
     ...
     *
     * @return A new instance of fragment Translate_Text.
     */
    // TODO: Rename and change types and number of parameters
    public static Translate_Text newInstance() {

//        Bundle args = new Bundle();
//        args.putString(ARG_PARAM1, param1);
//        args.putString(ARG_PARAM2, param2);
//        fragment.setArguments(args);
        return new Translate_Text();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_translate__text, container, false);
    ...
    private void change_play_pause(View view) {
        ...
        if(play_pause_id==R.id.play_pause_t){
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.translated_text_interface_callback();
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void translated_text_interface_callback();
    }
}
